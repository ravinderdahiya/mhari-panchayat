...
class PermissionSeeder extends Seeder
{
    ...
    private static function permissions(): array
    {
        ...
        return [
            ...
            ['key' => 'complaints.acknowledge', 'label' => 'Acknowledge complaints', 'group' => 'Complaints', 'roles' => ['sarpanch', 'secretary', 'gram_sachiv', 'bdpo', 'ddpo', 'deputy_commissioner']],
            ...
            ['key' => 'complaints.transfer', 'label' => 'Transfer complaints', 'group' => 'Complaints', 'roles' => ['sarpanch', 'secretary', 'gram_sachiv', 'bdpo', 'department_head', 'department_officer', 'admin', 'ddpo', 'deputy_commissioner']],
            ['key' => 'complaints.reopen', 'label' => 'Reopen complaints', 'group' => 'Complaints', 'roles' => ['citizen']],
            ['key' => 'complaints.reject', 'label' => 'Reject complaints', 'group' => 'Complaints', 'roles' => ['sarpanch', 'secretary', 'gram_sachiv', 'bdpo', 'department_head', 'department_officer', 'admin', 'ddpo', 'deputy_commissioner']],
