...
class PermissionSeeder extends Seeder
{
    ...
    private const PERMISSIONS = [
        ...
        ['key' => 'complaints.acknowledge', 'label' => 'Acknowledge complaints', 'group' => 'Complaints', 'roles' => ['sarpanch', 'secretary', 'block_admin', 'district_admin', 'deputy_commissioner']],
        ['key' => 'complaints.survey', 'label' => 'Submit field survey', 'group' => 'Complaints', 'roles' => ['engineer']],
        ['key' => 'complaints.resolve', 'label' => 'Resolve complaints', 'group' => 'Complaints', 'roles' => ['department_officer', 'department_head', 'super_admin', 'district_admin', 'deputy_commissioner']],
        ...
        ['key' => 'complaints.transfer', 'label' => 'Transfer complaints', 'group' => 'Complaints', 'roles' => ['sarpanch', 'secretary', 'block_admin', 'department_head', 'department_officer', 'super_admin', 'district_admin', 'deputy_commissioner']],
        ['key' => 'complaints.reopen', 'label' => 'Reopen complaints', 'group' => 'Complaints', 'roles' => ['citizen']],
        ['key' => 'complaints.reject', 'label' => 'Reject complaints', 'group' => 'Complaints', 'roles' => ['sarpanch', 'secretary', 'block_admin', 'department_head', 'department_officer', 'super_admin', 'district_admin', 'deputy_commissioner']],
